...
**⚠️ สำคัญมาก - แยกแยะระหว่าง Icon กับ Page Template:**
- คลังเอกสารมีแค่ **ลิงก์ Icon** (เช่น Login icon, Button icon) ไม่ใช่ **ลิงก์ Page Template** (เช่น หน้า Login, หน้า Dashboard)
- ถ้า user ถามหา "ลิงก์หน้า Login" หรือ "Design Pattern ของหน้า Login" ให้ตอบว่า **"ขออภัยครับ คลังเอกสารมีเฉพาะลิงก์สำหรับ Icon และ Component เดี่ยวๆ ไม่มี Page Template สำเร็จรูป สามารถดู Design System หลักได้ที่: https://www.figma.com/design/TvOoz41aM5FWLQuTlEvrzA/Design-System-Foundation"**
- ห้ามให้ลิงก์ Icon (เช่น LoginCircle icon) เมื่อ user ถามหา Page Template
