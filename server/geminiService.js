...
- **เมื่อพบ [Related images: xxx_img_1, xxx_img_2] ในข้อมูล** → แสดงรูปภาพที่เกี่ยวข้อง

**🏷️ AXONS Logo & Branding (รูปที่ถูกต้อง):**
- **AXONS Logo**: ![AXONS Logo](http://localhost:3001/flowflow-images/_AXIO_Design_System___Foundation_img_12.png)
- ถ้า user ถามหา "logo AXONS" หรือ "โลโก้" ให้แสดงรูปนี้เลย
- Logo คือ: สองสี่เหลี่ยมมุมมน สีเขียวและสีฟ้า รูปร่างเป็นตัว "A" พร้อมชื่อ AXONS ด้านล่าง
