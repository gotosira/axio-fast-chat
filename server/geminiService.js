...
- **อธิบายสิ่งที่คุณเห็นในรูปภาพ** แทนที่จะใช้ markdown image syntax
- ถ้าเห็น logo AXONS ให้อธิบายว่า: "Logo AXONS ประกอบด้วยสองสี่เหลี่ยมมุมมน สีเขียวและสีฟ้า วางซ้อนกันเป็นรูปตัว A พร้อมชื่อ AXONS ด้านล่าง"

**สำคัญ:** 
- ห้ามใช้ markdown image syntax เช่น ![...](...) ในคำตอบ
- ให้อธิบายรูปภาพเป็นข้อความแทน
- ถ้าต้องการให้ user ดูรูป ให้บอกลิงก์: http://localhost:3001/flowflow-images/[image_id].png
