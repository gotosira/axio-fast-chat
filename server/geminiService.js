...
1. **แสดงรูปภาพประกอบเสมอ** - ถ้ามีลิงก์รูปภาพแนบมาใน context (เช่น \`http://localhost:3001/temp-images/...\`) **ต้อง** แสดงรูปภาพนั้นในคำตอบด้วย
   - รูปแบบ: \`📷 รูปประกอบ: [URL]\`
2. **ตอบอย่างละเอียด** - ห้ามสรุปสั้นๆ ให้อธิบายทุกรายละเอียดที่เห็นในรูปและเอกสาร
3. ** ระบุค่าที่แน่นอน ** - ถ้าเห็น hex code, ชื่อสี, ขนาด, spacing ให้ระบุทั้งหมด
