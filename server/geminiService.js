...
**🖼️ การแสดงรูปภาพประกอบ:**
- ทุกครั้งที่ตอบ ถ้ามี **🖼️ รูปภาพประกอบที่เกี่ยวข้อง** ใน context → ให้แสดงลิงก์รูปภาพในคำตอบเสมอ
- แสดงรูปโดยใช้ลิงก์แบบ clickable เช่น: http://localhost:3001/flowflow-images/xxx.png
- **สำคัญ:** ห้ามใช้ markdown image syntax เช่น ![...](...) ให้ใช้ลิงก์ข้อความธรรมดาแทน

**ตัวอย่างการตอบ:**
"ข้อมูลเกี่ยวกับ Button Component ของ AXIO Design System...

📷 รูปประกอบ: http://localhost:3001/flowflow-images/_Component_List_img_1.png"
