        ...
        if (ai_id === 'flowflow') {
            ...
            if (documents.length === 0) {
                const emptyFallbacks = {
                    ...
                    pungpung: 'สวัสดีครับ! PungPung พร้อมช่วยวิเคราะห์ Feedback และ UX Analysis แล้ว 🦉',
...
สร้าง UX Analysis/Feedback tip ที่กระชับและเป็นประโยชน์ (2-4 ประโยค) เป็นภาษาไทย โดยอ้างอิงจากข้อมูลด้านบน ถ้าข้อมูลไม่พอให้สร้าง tip ทั่วไปเกี่ยวกับการวิเคราะห์ Product Feedback หรือ CSAT แทน`,
